...
public class SampleData implements Serializable, Comparable, Cloneable {
...
/**
  ...
  */
   ...
   /**
    * The extra feature in addition of the matrix data
    */
...
/**
  ...
  */
   public SampleData(char letter,int width,int height, int extraCount)
   {
     grid = new boolean[width][height];
     extra = extraCount > 0 ? new double[extraCount] : null;
     this.letter = letter;
   }
...
/**
  ...
  */
    ...
    * Set extra feature
    */
   public void setExtraData(int i, double v) {
	   extra[i] = v;
   }
...
/**
  ...
  */
...

   {
     ...
     SampleData obj = new SampleData(letter,getWidth(),getHeight(), extra != null ? extra.length : 0);
